...
### 4.1. Bảng so sánh 3 kịch bản kiến trúc
...
### 4.2. Sự liên kết và Cơ sở biện luận chọn HYBRID CLOUD
...
## BƯỚC 10: TỔ CHỨC DỰ ÁN VÀ CƠ CHẾ PHỐI HỢP (RACI)

### 10.1. Ma trận phân nhiệm (RACI)
...
### 10.2. Cơ chế phối hợp & Quản lý thay đổi
...
## BƯỚC 11: PHƯƠNG ÁN MUA SẮM VÀ CHỌN NHÀ THẦU

### 11.1. Hình thức mua sắm
...
### 11.2. Tiêu chí đánh giá nhà thầu
- **Kỹ thuật (Trọng số 70%):** 
  ...
  - Giải pháp đề xuất đáp ứng 100% yêu cầu kỹ thuật tại Bước 5.
- **Tài chính (Trọng số 30%):** Chi phí cạnh tranh, đảm bảo không vượt quá ngân sách CAPEX dự kiến.

### 11.3. Yêu cầu ràng buộc trong hợp đồng
...
## BƯỚC 12: KẾ HOẠCH NGHIỆM THU, VẬN HÀNH VÀ CHUYỂN GIAO

### 12.1. Nghiệm thu theo các lớp năng lực
...
### 12.2. Kế hoạch Chuyển giao (Handover)
