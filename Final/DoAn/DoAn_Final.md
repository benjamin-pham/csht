...
Dự án này đề xuất đầu tư Nền tảng tích hợp ứng dụng (Lớp 4) và Nền tảng dữ liệu tập trung (Lớp 5) cho chuỗi Ways Station nhằm giải quyết các thách thức nghiêm trọng về đứt gãy tích hợp, phân mảnh dữ liệu và rủi ro rò rỉ dữ liệu cá nhân (PII) trên 34+ chi nhánh.
...
Dự án được lên kế hoạch triển khai trong vòng 16 tuần (4 tháng) với 5 pha rõ ràng. Tổng mức đầu tư (CAPEX) là **1.308.800.000 VNĐ**, và Tổng chi phí sở hữu (TCO) trong 3 năm dự kiến là **5.209.160.000 VNĐ**. Lợi ích mang lại không chỉ giải quyết các vấn đề vận hành, tiết kiệm ~2.500 giờ công/năm, giảm sai lệch doanh thu mà còn nâng cấp khả năng ra quyết định theo thời gian thực với sự hỗ trợ của mô hình AI, cho thời gian thu hồi vốn ước tính khoảng 2.75 năm.
...
| TR-O03 | CMDB (Configuration Management Database) | Danh mục tài sản: 34 Edge devices + Cloud resources + License, cập nhật tự động | Quản trị tài sản | CMDB liệt kê 100% tài sản, thông chính xác so với thực tế |
...
| 2 | **[Lớp 4 & 5]** Apache Kafka | Open-source (Apache 2.0) | — | Miễn phí. Hoặc dùng Managed Kafka trên Cloud (tính vào OPEX) |
...
> **Chiến lược bản quyền:** Ưu tiên tối đa phần mềm mã nguồn mở ổn định, cộng đồng lớn để giảm chi phí license — phù hợp với ngân sách doanh nghiệp vừa (SMB). Tuân thủ đầy đủ điều khoản giấy phép OSS.
...
- Do đặc thù yêu cầu tích hợp phức tạp và tính bảo mật cao, phương thức mua sắm là **Chào giá cạnh tranh (RFP)** mời tối thiểu 3 nhà thầu CNTT có kinh nghiệm triển khai Cloud và Big Data.
...
- **Cam kết SLA & Phạt vi phạm:** Vendor phải cam kết SLA tích hợp và downtime tối đa trong thời gian Pilot. Phạt vi phạm hợp đồng nếu trễ tiến độ (ví dụ 1% giá trị hợp đồng/tuần trễ).
- **Cam kết bảo mật (NDA):** Ký NDA chặt chẽ về việc bảo vệ dữ liệu PII theo Nghị định 13/2023/NĐ-CP. Không sao chép dữ liệu khách hàng ra khỏi môi trường Test/Prod của doanh nghiệp.
