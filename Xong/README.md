# Thư mục Báo Cáo Cuối Kỳ (Hoàn Thiện)

Thư mục này chứa các tài liệu, slide báo cáo, và kịch bản thuyết trình đã hoàn thiện của Nhóm 5, sẵn sàng cho việc báo cáo Đồ án và Thực hành.
...
### Tài liệu
- **[DoAn_Slide_Nhom5.pptx](./DoAn_Slide_Nhom5.pptx)**: Slide báo cáo Đồ án môn học.
- **[kichban_doan.md](./kichban_doan.md)**: Kịch bản chi tiết dùng để thuyết trình Đồ án môn học.

### Phân công thuyết trình
| Người | Slide | Nội dung | Thời lượng |
|:---|:---:|:---|:---:|
| Phạm Minh Mẫn — Nhóm trưởng | 1–3, 20 | Mở đầu, phân công, tóm tắt điều hành, kết luận | 2'45" |
...
### Tài liệu
- **[ThucHanh_Slide_Nhom5.pptx](./ThucHanh_Slide_Nhom5.pptx)**: Slide báo cáo bài tập Thực hành.
- **[kichban_thuchanh.md](./kichban_thuchanh.md)**: Kịch bản chi tiết dùng để thuyết trình Thực hành.

### Phân công thuyết trình
| Người | Slide | Nội dung | Thời lượng |
|:---|:---:|:---|:---:|
| Phạm Minh Mẫn — Nhóm trưởng | 1–2, 19 | Mở đầu, giới thiệu đề tài, phân công, kết luận | 1'50" |
| Đặng Nguyễn Minh Anh | 3–4 | Bối cảnh, hiện trạng, tính cấp thiết | 1'50" |
| Trần Văn Phây | 5–6 | Mục tiêu tổng quát, KPI nhóm A | 1'50" |
| Huỳnh Thị Kiều Uyên | 7–8 | KPI nhóm B, ánh xạ KPI theo giai đoạn | 1'45" |
| Trần Việt Đức | 9–10 | Phạm vi, giới hạn AI, yêu cầu nghiệp vụ | 1'50" |
